<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login-parents.aspx.cs" Inherits="login_teacher" %>
							...
							<h3>Parent Login</h3>
												<form runat="server" id="Login_teacher_form">
													...
													<div class="content-justify divider_20">
                                                        ...
                                                        <asp:LinkButton ID="lostpassword" OnClick="lostpassword_Click" runat="server">Lost password?</asp:LinkButton>
													</div>
												...
												<p class="topmargin_10 text-center grey highlightlinks">Not a member yet? <a href="register-parents.aspx">Register now</a></p>
							</div>
