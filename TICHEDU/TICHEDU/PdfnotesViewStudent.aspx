<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PdfnotesViewStudent.aspx.cs" Inherits="PdfnotesViewStudent" %>
...
<div class="form-group"><asp:DropDownList ID="subjdrop" CssClass="form-control" runat="server"></asp:DropDownList>  </div>
 ...
 <p> FOR CLASS <%# Eval("PDF_CLASS") %></p>
       ...
       <div> <asp:LinkButton ID="lnkDownload" runat="server" Text="View" OnClick="lnkDownload_Click"
            ...
            <FooterTemplate>
    <asp:Label Font-Italic="true" Font-Size="Large" ForeColor="Red" Visible='<%#bool.Parse((DataList1.Items.Count==0).ToString())%>' 
