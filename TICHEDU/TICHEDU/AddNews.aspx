...
<div class="popup-box chat-popup" id="qnimate">
    ...
    <label for="exampleInputEmail1">News Date </label>
         <asp:TextBox ID="news_date" placeholder="dd/mm/yyyy" class="form-control"    runat="server"></asp:TextBox>
             </div>
       
  
       <div class="form-group">
            <label for="exampleInputPassword1">News Title</label>
             <asp:TextBox ID="news_title" TextMode="SingleLine" CssClass="form-control" runat="server"></asp:TextBox>
           </div>
                    <div class="form-group">
            <label for="exampleInputPassword1">News data</label>
             <asp:TextBox ID="news_data" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
           </div>
       <div class="form-group">
    <asp:Button ID="submit" runat="server" OnClick="submit_Click" Text="Submit" /><asp:Label CssClass="badge" ID="msg" runat="server" Text=""></asp:Label>
           </div>
       </div>
    <div class="container">
    ...
    <thead>
      <tr>
        <th style="color:black">News Date</th>
       
          <th style="color:black">New Title</th>
          <th style="color:black">News Details</th>
           <th style="color:black">News Action</th>
      </tr>
        ...
        <asp:DataList ID="DataList1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td><%# Eval("News_details") %> </td> 
                    <td><asp:Button ID="delete" runat="server" Text="Delete"  OnClick="delete_Click" CommandArgument='<%# Eval("Newsid") %>' /></td>
      </tr>
