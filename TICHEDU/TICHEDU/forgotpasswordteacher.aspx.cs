...
public partial class forgotpassteacher : System.Web.UI.Page
{
    ...
    protected void Requestpassword_btn_Click1(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            sucess = forgotPassword.Getuserpass(email_txtbox.Text, "select TEACHER_PASSWORD from TBL_TEACHER_REGISTRATION where TEACHER_EMAIL=@Email", "TEACHER_PASSWORD");
            if (sucess == "ok")
            {
