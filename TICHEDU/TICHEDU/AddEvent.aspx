...
<div class="popup-box chat-popup" id="qnimate">
    ...
    <label for="exampleInputEmail1">Event Date </label>
         <asp:TextBox ID="event_date" placeholder="dd/mm/yyyy" class="form-control"    runat="server"></asp:TextBox>
             </div>
       
  
       <div class="form-group">
            <label for="exampleInputPassword1">Event Title</label>
             <asp:TextBox ID="event_title" TextMode="SingleLine" CssClass="form-control" runat="server"></asp:TextBox>
           </div>
                    <div class="form-group">
            <label for="exampleInputPassword1">Event data</label>
             <asp:TextBox ID="event_data" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
           </div>
       <div class="form-group">
    ...
    <thead>
      <tr>
        <th style="color:black">Event Date</th>
          ...
          <th style="color:black">Event Title</th>
          <th style="color:black">Event Details</th>
        ...
        <asp:DataList ID="DataList1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:Button ID="delete" runat="server" Text="Delete"  OnClick="delete_Click" CommandArgument='<%# Eval("Eventid") %>' /></td>
               </tr>
