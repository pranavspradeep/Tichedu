<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher_video_upload.aspx.cs" Inherits="teacher_video_upload" %>
<!DOCTYPE html>
...
<p class=" text-danger">For Class(*):</p>
 ...
 <p  class=" text-danger"> Video file input(*):</p>
                     <asp:FileUpload ID="Video_upload"  class="form-control-file" runat="server" />  
   ...
   <div >
             <p style="color:red;font-style:italic"><asp:Label ID="message" runat="server" Text=""></asp:Label></p>   </div>
                ...
                <!---JUMPTRON PDF UPLOADS---->
                
                 <div class=" container">
                     <div class="jumbotron">
      <h3>PDF UPLOAD</h3>
			
 <p class="text-danger"> Pdf Title(*):</p>
    <asp:TextBox ID="pdf_title_txtbox" class="form-control" runat="server"></asp:TextBox>
  

   <p class="text-danger"> For Class(*):</p>
     <asp:DropDownList ID="classdroppdf" class="form-control"  runat="server"></asp:DropDownList>
 <p class="text-danger">  Subject(*)</p>
        <asp:DropDownList ID="Subjdroppdf" class="form-control"  runat="server"></asp:DropDownList>        

               
 <p class="text-danger"> Pdf file input(*)</p>
                <asp:FileUpload ID="pdf_file_upload"  class="form-control-file" runat="server" />

 
<div id="pdf_subbtn" style="margin-top:5px">
                    <asp:Button ID="PDF_UP" class="theme_button color2" OnClicK="Pdf_upload_btn_Click" runat="server" Text="Submit" />
             </div> 
            

       
             <p style="color:red;font-style:italic"> <asp:Label ID="messagepdf" runat="server" Text=""></asp:Label></p>
