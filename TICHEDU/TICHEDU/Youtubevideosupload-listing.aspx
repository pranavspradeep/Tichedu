<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Youtubevideosupload-listing.aspx.cs" Inherits="Youtubevideosupload" %>
<!DOCTYPE html>
					...
					<div class="col-sm-6 "  style="float:right;">									
						...
						<div class="col-sm-6 text-center text-sm-right">
							<ul class="inline-list menu darklinks">
                                ...
                                <li><a href="login-teacher.aspx" class="small-text medium"><i class="fa fa-sign-out"></i>Sign out</a></li></li>
						...
						<div class="header-side-menu darklinks">
							...
							<a href="index.aspx" class="logo top_logo">
								...
								<ul class="nav menu-click">
									...
									<li>
										 <asp:LinkButton ID="youtube_videos_link" OnClick="youtubevideos_Click" runat="server">TichEdu YouTube Videos</asp:LinkButton>
									</li>
									<li>
...
<div class="popup-box chat-popup" id="qnimate">
           ...
           <div class="container">
               <div style="margin-left:10px">
                <asp:Button ID="Addvideobtn"  runat="server" OnClick="Addvideobtn_Click" Text="Add Youtube video" />
               </div>
    <asp:DataList ID="DataListvideo" runat="server" cssClass="row" RepeatLayout="Flow" RepeatDirection="Horizontal" >
                          
        
        <ItemTemplate>
                          <div class="col-sm-3 col-md-3 col-lg-3"><div class="embed-responsive  embed-responsive-4by3" >
                              
                          <iframe  id="VideoPlayer"  src="https://www.youtube.com/embed/<%# Eval("YOUTUBE_LINK") %>?start=<%# Eval("YSTART") %> &end=<%# Eval("YEND") %> " class="embed-responsive-item" allowfullscreen ></iframe>
                          
                          </div>
					<div class="p-3 mb-2 bg-danger text-white" >TITLE:<%# Eval("YOUTUBE_TITLE") %></div>

                                 <div class="p-3 mb-2 bg-danger text-white ">VIDEO FRO CLASS:<%# Eval("YOUTUBE_CLASS") %></div>    
                                <div class="p-3 mb-2 bg-danger text-white ">SUBJECT:<%# Eval("YOUTUBE_SUBJECT") %></div>
                              
                                  <asp:LinkButton ID="delete" OnClick="delete_Click"  CommandArgument='<%# Eval("YOU_ID") %>'   runat="server">DELETE</asp:LinkButton>
        ...
        <FooterTemplate>
    <asp:Label Font-Italic="true" Font-Size="Large" ForeColor="Red" Visible='<%#bool.Parse((DataListvideo.Items.Count==0).ToString())%>' 
