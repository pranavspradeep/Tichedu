						...
						<div class="header-side-menu darklinks">
							...
							<a href="index.html" class="logo top_logo">
								...
								<ul class="nav menu-click">
									...
									<li>
										<a href="#">Nofications</a>
									<li>
										<a href="#">Results</a>
									</li>
									</li>
									<li>
										<a href="#"> Exam Result Comparisions</a>
									</li>
									<li>
										<a href="#"> Attend classes</a>
									</li>
									<li>
										<a href="#"> Chat</a>
									</li>
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-4">
							...
							<div class="widget widget_categories">
								...
								<h3 class="widget-title">Attend Classes</h3>
								<ul class="greylinks list2 star-bullets">
									<li class="active">
										<a class="content-justify">
						...
						<hr>
							...
							<div class="widget widget_search">
								<h3 class="widget-title">Check Result</h3>
								<form method="get" class="searchform" action="#">

									<div class="form-group">
										<label class="sr-only" for="widget-search">Enter Register Number</label>
										<input id="widget-search" type="text" value="" name="search" class="form-control" placeholder="Enter Register Number">
									</div>
