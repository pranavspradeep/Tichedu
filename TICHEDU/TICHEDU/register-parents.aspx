<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register-parents.aspx.cs" Inherits="register_parents" %>
<!DOCTYPE html>
					...
					<div class="row">
						...
						<div class="col-md-12 to_animate" data-animation="scaleAppear">
							...
							<form class="contact-form row columns_padding_10" method="post" action="#">
								...
								<div class="col-sm-6">
									<label>Your Student Email<span class="required"></span>
</label>
								...
								<div class="col-sm-6">
									...
									<input type="text" runat="server" id="Username_txtbox" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Enter valid email" class="form-control" autofocus  >
								</div>
								<div class="col-sm-6">
