<%@ Page Language="C#" AutoEventWireup="true" CodeFile="parentExamResult.aspx.cs" Inherits="parentExamResults" %>
					...
					<div class="col-sm-6 "  style="float:right;">									
					  ...
					  <div class="col-sm-6 text-center text-sm-right">
							<ul class="inline-list menu darklinks">
								...
								<li><a href="login-parents.aspx" class="small-text medium"><i class="fa fa-sign-out"></i>Sign out</a></li>
							...
							<a href="index.aspx" class="logo top_logo">
								...
								<ul class="nav menu-click">
                                    <li> <asp:LinkButton ID="Student_Recent_Activity"  OnClick="Student_Recent_Activity_Click" runat="server">Recent Student Activities</asp:LinkButton></li>
									 <li> <asp:LinkButton ID="results"  OnClick="results_Click" runat="server">Results</asp:LinkButton></li>
                                    <!--<li >
