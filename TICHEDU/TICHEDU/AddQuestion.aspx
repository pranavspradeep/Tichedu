...
<div class="popup-box chat-popup" id="qnimate">
            ...
            <form runat="server">
                ...
                <div class="jumbotron">
                    ...
                    <asp:TextBox ID="Question_txtbox" runat="server" CssClass="form-control"></asp:TextBox>
                    <p class="text-danger">Option 1</p>
                    <asp:TextBox ID="option1_txtbox" runat="server" CssClass="form-control" ></asp:TextBox>
                    <p class="text-danger">Option 2</p>
                    <asp:TextBox ID="option2_txtbox" runat="server" CssClass="form-control" ></asp:TextBox>
                     <p class="text-danger">Option 3</p>
                    <asp:TextBox ID="option3_txtbox" runat="server" CssClass="form-control" ></asp:TextBox>
                     <p  class="text-danger">Option 4</p>
                    <asp:TextBox ID="option4_txtbox" runat="server" CssClass="form-control" ></asp:TextBox>
                    <p class="text-danger">Answer</p>
                     <asp:TextBox ID="Answer_txtbox" runat="server" CssClass="form-control" ></asp:TextBox>
                    
                    <asp:Button ID="Sub_btn" runat="server" CssClass="form-control" OnClick="Sub_btn_Click" Text="Submit" />
                    <asp:Label ID="message" runat="server" ForeColor="Red" Text=""></asp:Label> </div>
                </div>      
          </form>  
