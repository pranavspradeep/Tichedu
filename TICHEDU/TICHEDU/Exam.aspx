...
<asp:Timer ID="Timer1" runat="server" Interval="40000" ontick="Timer1_Tick" >
        ...
        <asp:UpdatePanel ID="UpdatePanel1"
            ...
            <tr>
                ...
                <td> <asp:Label ID="qid_label" runat="server" Font-Bold="True"></asp:Label>
        ...
        <table class="auto-style1" style="background-color: #FFFFFF">
            ...
            <tr>
                ...
                <td class="auto-style5">&nbsp;</td>
                <td>
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/img/button_submit.png" OnClick="ImageButton2_Click" />
                </td>
            </tr>
        </table>
