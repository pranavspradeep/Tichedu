<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login-Admin.aspx.cs" Inherits="login_admin" %>
							...
							<h3>Admin Login</h3>
												<form runat="server" id="Login_teacher_form">
													...
													<div class="form-group has-placeholder">
														...
														<input  runat="server" class="form-control" id="login_email" placeholder="Email Address">
													</div>
