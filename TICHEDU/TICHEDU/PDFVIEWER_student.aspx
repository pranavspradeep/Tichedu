<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PDFVIEWER_student.aspx.cs" Inherits="PDFVIEWER_student" %>
							...
							<a href="index.aspx" class="logo top_logo">
								...
								<ul class="nav menu-click">
									<li class="active">
									 ...
									 <asp:LinkButton ID="Pdfnoteslink_btn"  OnClick="pdfnoteslink_Click" runat="server">Pdf Notes</asp:LinkButton>
                                    ...
                                    <li>
									 ...
									 <asp:LinkButton ID="video_link"  OnClick="Videoslink_Click" runat="server">Videos</asp:LinkButton>
...
<div class="popup-box chat-popup" id="qnimate">
   ...
   <div class="embed-responsive embed-responsive-16by9">
       <asp:Label ID="ltEmbed" runat="server" Text="" class="embed-responsive-item"></asp:Label>
