<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student-profile.aspx.cs" Inherits="student_profile" %>
							...
							<div class="header_mainmenu display_table_cell text-center">
								...
								<nav class="mainmenu_wrapper">
									<ul class="mainmenu nav sf-menu">
										<li class="active">
                                            <form id="form_nav" runat="server">
                                            <asp:LinkButton ID="video_limk" runat="server" OnClick="video_limk_Click">Videos</asp:LinkButton></li>
											...
											<div class="item-content">
												...
												<header class="entry-header">
													<h4 class="entry-title ">
														<a href="#" rel="bookmark">
                                                            <asp:Label ID="Name_2" runat="server" Text=""></asp:Label>&nbsp; <asp:Label ID="last_name2" runat="server" Text=""></asp:Label></a>
													</h4>
